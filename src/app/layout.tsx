...
export const metadata: Metadata = {
  ...
  description:
    "Senior Software Engineer based in New York. React, Next.js, TypeScript, Ethereum/Web3. 10+ years building scalable web applications and blockchain solutions.",
};
